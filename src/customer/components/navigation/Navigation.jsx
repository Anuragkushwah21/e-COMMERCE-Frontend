          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white shadow-xl">
                ...
                <Tab.Group as="div" className="mt-2">
                  <div className="border-b border-gray-200">
                    <Tab.List className="flex space-x-8 px-4">
                      ...
                      flex-1 whitespace-nowrap py-4 text-base font-medium`
                          }
                        >
                          {category.name}
                        </Tab>
                              ...
                              {section.items.map((item) => (
                                <li key={item.name}>
                                  <button
                                    ...
                                    className="text-gray-700 hover:text-indigo-600 text-left w-full"
                                  >
                                    {item.name}
                                  </button>
                                </li>
                ...
                {/* Sign In Button */}
                <div className="border-t border-gray-200 px-4 py-4 flex items-center space-x-4">
                  {auth.user?.firstName ? (
                    <>
                      <Avatar
